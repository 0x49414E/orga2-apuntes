...
#define GDT_CODE_0_SEL (uint16_t)(GDT_IDX_CODE_0 << SEL_SHIFT)
#define GDT_DATA_0_SEL (uint16_t)(GDT_IDX_DATA_0 << SEL_SHIFT)
#define GDT_CODE_3_SEL (uint16_t)((GDT_IDX_CODE_3 << SEL_SHIFT)|RPL_3)
#define GDT_DATA_3_SEL (uint16_t)((GDT_IDX_DATA_3 << SEL_SHIFT)|RPL_3)
