...
// Es necesario que sea de código ya que las interrupciones ocurren a nivel de segmentos de código.
// Luego, como es de nivel 0, el único selector posible debe ser el de código de nivel 0.
// Además, el tipo debe ser 0b0(1)110 ya que estamos en 32 bits. 
// Seteamos present en 1 debido a que el segmento está cargado en memoria.
